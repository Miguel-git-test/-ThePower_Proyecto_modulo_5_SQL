...
/*6.Encuentra el nombre y apellido de los actores que tengan ‘Allenʼ en su apellido.*/
	...
	from public.actor
	where upper(last_name) = upper('Allen')	 
...
/*58.Encuentra el título de todas las películas que son de la misma categoría que ‘Animationʼ.*/
	...
	join public.film c on b.film_id = c.film_id
	join public.film_category d on a.category_id = d.category_id
	join public.film e on d.film_id = e.film_id
	where a.name = 'Animation'
